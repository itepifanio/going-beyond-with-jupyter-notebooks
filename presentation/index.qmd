...
How can we publish the package in PyPI and download it using?
...
- Jupyter notebooks are awesome for rapid prototyping
...
- Visual libraries benefits a lot from nbdev
